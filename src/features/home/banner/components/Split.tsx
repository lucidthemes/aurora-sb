...
export default function BannerSplit({ banner, excerptLength }: { banner: Banner; excerptLength?: number }) {
  let mediaUrl = '';
  ...
  return (
    <div className="flex h-125 overflow-hidden rounded-md">
      <div className="flex basis-1/3 flex-col items-start justify-center bg-white p-5 md:p-7.5 lg:p-10">
        <BannerContent banner={banner} align="left" excerptLength={excerptLength} />
      </div>
