...
export default function BlogPostHeaderSplitLayout({ post, content }: { post: Post; content: ReactNode }) {
  let mediaUrl = '';
  ...
  return (
    <div className="flex flex-col overflow-hidden rounded-sm md:h-125 md:flex-row">
      ...
      <div className="min-h-40 basis-1/2 bg-cover bg-center bg-no-repeat lg:basis-2/3" style={{ backgroundImage: `url(${mediaUrl})` }}></div>
    </div>
  );
}
