...
The app uses a Postgres database that is hosted on Supabase

## Schema

The generated schema can be viewed in full [here](https://github.com/lucidthemes/aurora-sb/blob/main/docs/schema.png).
...
- [View on GitHub](https://github.com/lucidthemes/aurora-sb/tree/main/supabase/migrations)
